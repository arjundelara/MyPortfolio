...
{var field=$(this);field.removeClass('fl-form-error');field.siblings('.fl-form-error-message').hide();}};$(function(){FLBuilderLayout.init();});})(jQuery);(function($){if($(window).width()<=768&&$(window).width()>=481){$('.fl-node-5dfc5bdca8e1b .pp-heading-separator, .fl-node-5dfc5bdca8e1b .pp-heading').removeClass('pp-left');$('.fl-node-5dfc5bdca8e1b .pp-heading-separator, .fl-node-5dfc5bdca8e1b .pp-heading').addClass('pp-tablet-');}
if($(window).width()<=480){$('.fl-node-5dfc5bdca8e1b .pp-heading-separator, .fl-node-5dfc5bdca8e1b .pp-heading').removeClass('pp-left');$('.fl-node-5dfc5bdca8e1b .pp-heading-separator, .fl-node-5dfc5bdca8e1b .pp-heading').addClass('pp-mobile-');}})(jQuery);(function($){if($(window).width()<=768&&$(window).width()>=481){$('.fl-node-5dfc76aba30c7 .pp-heading-separator, .fl-node-5dfc76aba30c7 .pp-heading').removeClass('pp-left');$('.fl-node-5dfc76aba30c7 .pp-heading-separator, .fl-node-5dfc76aba30c7 .pp-heading').addClass('pp-tablet-');}
if($(window).width()<=480){$('.fl-node-5dfc76aba30c7 .pp-heading-separator, .fl-node-5dfc76aba30c7 .pp-heading').removeClass('pp-left');$('.fl-node-5dfc76aba30c7 .pp-heading-separator, .fl-node-5dfc76aba30c7 .pp-heading').addClass('pp-mobile-');}})(jQuery);(function($){if($(window).width()<=768&&$(window).width()>=481){$('.fl-node-5dfc7a68744c9 .pp-heading-separator, .fl-node-5dfc7a68744c9 .pp-heading').removeClass('pp-left');$('.fl-node-5dfc7a68744c9 .pp-heading-separator, .fl-node-5dfc7a68744c9 .pp-heading').addClass('pp-tablet-');}
if($(window).width()<=480){$('.fl-node-5dfc7a68744c9 .pp-heading-separator, .fl-node-5dfc7a68744c9 .pp-heading').removeClass('pp-left');$('.fl-node-5dfc7a68744c9 .pp-heading-separator, .fl-node-5dfc7a68744c9 .pp-heading').addClass('pp-mobile-');}})(jQuery);var FLBuilderNumber;(function($){FLBuilderNumber=function(settings){this.nodeClass='.fl-node-'+settings.id;this.wrapperClass=this.nodeClass+' .fl-number';this.layout=settings.layout;this.type=settings.type;this.number=parseFloat(('undefined'!==typeof window["number_module_"+settings.id])?window["number_module_"+settings.id].number:settings.number);this.max=parseFloat(('undefined'!==typeof window["number_module_"+settings.id])?window["number_module_"+settings.id].max:settings.max);this.speed=settings.speed;this.delay=settings.delay;this.breakPoints=settings.breakPoints;this.currentBrowserWidth=$(window).width();this.animated=false;this.format=settings.format;this._initNumber();};FLBuilderNumber.prototype={nodeClass:'',wrapperClass:'',layout:'',type:'',number:0,max:0,speed:0,delay:0,format:{},_initNumber:function(){var self=this;if(typeof jQuery.fn.waypoint!=='undefined'&&!this.animated){$(this.wrapperClass).waypoint({offset:FLBuilderLayoutConfig.waypoint.offset+'%',triggerOnce:true,handler:function(direction){self._initCount();}});}else{self._initCount();}},_initCount:function(){var $number=$(this.wrapperClass).find('.fl-number-string');if(!isNaN(this.delay)&&this.delay>0){setTimeout(function(){if(this.layout=='circle'){this._triggerCircle();}else if(this.layout=='bars'){this._triggerBar();}
...
return x1+x2;},};})(jQuery);(function($){$(function(){new FLBuilderNumber({id:'5dfc8c8cd9375',layout:'circle',type:'percent',number:parseFloat(('undefined'!==typeof window.number_module_5dfc8c8cd9375)?window.number_module_5dfc8c8cd9375.number:50),max:parseFloat(('undefined'!==typeof window.number_module_5dfc8c8cd9375)?window.number_module_5dfc8c8cd9375.max:50),speed:1000,delay:1,format:{decimal:'.',thousands_sep:','}});});})(jQuery);(function($){$(function(){new FLBuilderNumber({id:'5e006370ea990',layout:'bars',type:'percent',number:parseFloat(('undefined'!==typeof window.number_module_5e006370ea990)?window.number_module_5e006370ea990.number:80),max:parseFloat(('undefined'!==typeof window.number_module_5e006370ea990)?window.number_module_5e006370ea990.max:80),speed:3000,delay:1,format:{decimal:'.',thousands_sep:','}});});})(jQuery);(function($){$(function(){new FLBuilderNumber({id:'5e00656646f92',layout:'bars',type:'percent',number:parseFloat(('undefined'!==typeof window.number_module_5e00656646f92)?window.number_module_5e00656646f92.number:100),max:parseFloat(('undefined'!==typeof window.number_module_5e00656646f92)?window.number_module_5e00656646f92.max:100),speed:3000,delay:1,format:{decimal:'.',thousands_sep:','}});});})(jQuery);(function($){$(function(){new FLBuilderNumber({id:'5e0065ac9eb79',layout:'bars',type:'percent',number:parseFloat(('undefined'!==typeof window.number_module_5e0065ac9eb79)?window.number_module_5e0065ac9eb79.number:80),max:parseFloat(('undefined'!==typeof window.number_module_5e0065ac9eb79)?window.number_module_5e0065ac9eb79.max:80),speed:3000,delay:1,format:{decimal:'.',thousands_sep:','}});});})(jQuery);(function($){$(function(){new FLBuilderNumber({id:'5e006816e46eb',layout:'bars',type:'percent',number:parseFloat(('undefined'!==typeof window.number_module_5e006816e46eb)?window.number_module_5e006816e46eb.number:80),max:parseFloat(('undefined'!==typeof window.number_module_5e006816e46eb)?window.number_module_5e006816e46eb.max:80),speed:3000,delay:1,format:{decimal:'.',thousands_sep:','}});});})(jQuery);