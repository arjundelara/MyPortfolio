  ...
  <div class="wrap about-wrap griddist-add-css">
    <div>
      ...
      <div class="feature-section three-col">
        ...
        <div class="col">
          <div class="widgets-holder-wrap">
            <h3><?php echo __("View our other themes", "griddist"); ?></h3>
            <p><?php echo __("Do you like our concept but feel like the design doesn't fit your need? Then check out our website for more designs.", "griddist"); ?></p>
            <p><a target="blank" href="<?php echo esc_url('https://superbthemes.com/wordpress-themes/', 'griddist'); ?>" class="button button-primary">
              <?php echo __("View All Themes", "griddist"); ?>
            </a></p>
          </div>
        </div>
        <div class="col">
