<?php
/**
 * lifestylepress Theme Customizer
 *
 ...
 */
function lifestylepress_customize_register( $wp_customize ) {
	...
	if ( isset( $wp_customize->selective_refresh ) ) {
		$wp_customize->selective_refresh->add_partial( 'blogname', array(
			...
			'render_callback' => 'lifestylepress_customize_partial_blogname',
			) );
		$wp_customize->selective_refresh->add_partial( 'blogdescription', array(
			'selector'        => '.site-description',
			'render_callback' => 'lifestylepress_customize_partial_blogdescription',
			) );
	}
	$wp_customize->add_section( 'background_color', array(
		'title'      => __('Background Color','lifestylepress'),
		'priority'   => 1,
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'website_background_color', array(
		'label'       => __( 'Background Color', 'lifestylepress' ),
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'sidebar_headline_color', array(
		'label'       => __( 'Sidebar Headline Color', 'lifestylepress' ),
		'section'     => 'colors',
		'priority'   => 1,
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'sidebar_link_color', array(
		'label'       => __( 'Sidebar Link Color', 'lifestylepress' ),
		'section'     => 'colors',
		'priority'   => 1,
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'sidebar_text_color', array(
		'label'       => __( 'Sidebar Text Color', 'lifestylepress' ),
		'section'     => 'colors',
		'priority'   => 1,
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'sidebar_border_color', array(
		'label'       => __( 'Sidebar Border Color', 'lifestylepress' ),
		'section'     => 'colors',
		'priority'   => 1,
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'header_background_color', array(
		'label'       => __( 'Header Background Color', 'lifestylepress' ),
		'section'     => 'colors',
		'priority'   => 1,
...
add_action( 'customize_register', 'lifestylepress_customize_register' );




if(! function_exists('lifestylepress_customizer_css_final_output' ) ):
	function lifestylepress_customizer_css_final_output(){
		...
		<?php }
		add_action( 'wp_head', 'lifestylepress_customizer_css_final_output' );
		endif;
 ...
 * @return void
 */
function lifestylepress_customize_partial_blogname() {
	bloginfo( 'name' );
}
 ...
 * @return void
 */
function lifestylepress_customize_partial_blogdescription() {
 ...
 */
function lifestylepress_customize_preview_js() {
	wp_enqueue_script( 'lifestylepress-customizer', get_template_directory_uri() . '/js/customizer.js', array( 'customize-preview' ), '20151215', true );
}
add_action( 'customize_preview_init', 'lifestylepress_customize_preview_js' );
