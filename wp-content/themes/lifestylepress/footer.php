...
<footer id="colophon" class="site-footer clearfix">
	...
	<div class="content-wrap">
		...
		<div class="site-info">
		&copy;<?php echo esc_html(date_i18n(__('Y','lifestylepress'))); ?> <?php bloginfo( 'name' ); ?>

			<!-- Delete below lines to remove copyright from footer -->
			<span class="footer-info-right">
			<?php echo esc_html(' | WordPress Theme by', 'lifestylepress') ?> <a href="<?php echo esc_url('https://superbthemes.com/', 'lifestylepress'); ?>"><?php echo esc_html(' Superbthemes', 'lifestylepress') ?></a>
			</span>
