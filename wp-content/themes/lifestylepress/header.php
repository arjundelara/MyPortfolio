			...
			<div class="content-wrap">
				...
				<?php else : ?>
					...
					<nav id="primary-site-navigation" class="primary-menu main-navigation clearfix">
						...
						<a href="#" id="pull" class="smenu-hide toggle-mobile-menu menu-toggle" aria-controls="secondary-menu" aria-expanded="false"><?php esc_html_e( 'Menu', 'lifestylepress' ); ?></a>
						...
						<div class="super-menu clearfix">
							<div class="super-menu-inner">
								<a href="#" id="pull" class="toggle-mobile-menu menu-toggle" aria-controls="secondary-menu" aria-expanded="false"><?php esc_html_e( 'Menu', 'lifestylepress' ); ?></a>
							</div>
						</div>
