...
<img class="carousel-no-image" src="<?php echo esc_url(new_york_business_TEMPLATE_DIR_URI.'/images/header.png'); ?>" alt="<?php esc_attr_e('No Image','new-york-business'); ?>" style="height:350px;">
	...
	<div style="background:url(<?php echo esc_url($url); ?>) no-repeat;background-position:center center;background-size:cover;height:<?php echo absint($new_york_business_option['slider_image_height']); ?>px;" alt="<?php echo esc_attr($alt); ?>" ></div>	     
	  ...
	  <div class="carousel-caption custom-caption">
        <?php
			...
			the_content(__('See More','new-york-business'));
			echo '<a class="start-button" href="'.esc_url($new_york_business_option['slider_button_url']).'" >'.esc_html($new_york_business_option['slider_button_text']).'</a>';
