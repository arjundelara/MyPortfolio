...
$wp_customize->add_section( 'new_york_business_lite' , array(
		...
		$wp_customize->add_control( new new_york_business_more_Control( $wp_customize, 'new_york_business_lite', array(
...
if ( class_exists( 'WP_Customize_Control' ) && ! class_exists( 'new_york_business_more_Control' ) ) :
class new_york_business_more_Control extends WP_Customize_Control {
	...
	public function render_content() {
		...
		<label style="overflow: hidden; zoom: 1;">
			...
			<div class="col-md-3 col-sm-6" style="font-weight:500;">
				...
				<tr>
				<td>
				<div align="left"><i style="color: rgb(38, 191, 38);" class="fa fa-check"></i> <?php esc_html_e('* Cached Widgets (Product Widgets including featured, by category, top sales, product by review, latest products, product slider, featured slider, banner and contact, service, team etc:)', 'new-york-business'); ?></div></td>
				</tr>
				
				<tr>
				<td>
				<div align="left"><i style="color: rgb(38, 191, 38);" class="fa fa-check"></i> <?php esc_html_e('* 14+ Widgets (service, team, slider, contact, 5+ WooCommerce product sliders, counter(animated), progressbar(animated), accordion(animated) etc: )','new-york-business'); ?></div></td>
				</tr>			
