...
<form role="search" method="get" class="search-form" action="<?php echo esc_url( home_url( '/' ) ); ?>">
	...
	<input type="search" id="<?php echo esc_attr($new_york_business_id); ?>" class="search-field" placeholder="<?php echo esc_attr_x( 'Search &hellip;', 'placeholder', 'new-york-business' ); ?>" value="<?php echo esc_attr(get_search_query()); ?>" name="s" />
